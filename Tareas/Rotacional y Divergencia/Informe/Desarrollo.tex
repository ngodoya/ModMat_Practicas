...
\frac{\partial}{\partial x} & \frac{\partial}{\partial y} & \frac{\partial}{\partial z} \\
P & Q & 0
\end{vmatrix} = \hat{i}\left(\frac{\partial 0}{\partial y} - \frac{\partial Q}{\partial z}\right) + \hat{j}
...
\frac{\partial P}{\partial y}\right) \text{donde} \quad z = \frac{\partial Q}{\partial x} - \frac{\partial P}{\partial y}$$
